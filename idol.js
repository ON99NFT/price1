const IDOL = (() => {
    ...
    function handleAudioInitialization() {
        ...
        enableButton.id = 'idol-audio-enable-btn';
        ...
        const section = document.getElementById('idol-buy-alert').closest('.token-section');
    ...
    async function fetchMexcPrice() {
        try {
            ...
            const response = await fetch(proxyUrl + 'https://contract.mexc.com/api/v1/contract/depth/IDOL_USDT');
    ...
    async function fetchKyberPrice() {
        const addresses = {
            ...
            IDOL: '0x3b4de3c7855c03bb9f50ea252cd2c9fa1125ab07'
        };
    ...
    async function updateAlerts() {
        const elements = {
            buy: document.getElementById('idol-buy-alert'),
            sell: document.getElementById('idol-sell-alert')
        };
...
// Updated alert styling function for IDOL
function applyAlertStyles(element, value) {
    element.className = '';
    let shouldPlaySound = false;
    const isBuyAlert = element.parentElement.id === 'idol-buy-alert';
