const STAR10 = (() => {
    ...
    function handleAudioInitialization() {
        ...
        enableButton.id = 'star10-audio-enable-btn';
        ...
        enableButton.addEventListener('click', async () => {
          ...
          const section = document.getElementById('star10-buy-alert').closest('.token-section');
  ...
  // Keep the rest of the code the same as previous version
    ...
    async function fetchMexcPrice() {
        try {
            ...
            const response = await fetch(proxyUrl + 'https://contract.mexc.com/api/v1/contract/depth/STAR10_USDT');
    ...
    async function fetchKyberPrice() {
        const addresses = {
            ...
            STAR10: '0x8B9ABDD229ec0C4A28E01b91aacdC5dAAFc25C2b'
        };
    ...
    async function updateAlerts() {
        const elements = {
            buy: document.getElementById('star10-buy-alert'),
            sell: document.getElementById('star10-sell-alert')
        };
        ...
        try {
            ...
            const differences = {
                buy: (mexcData.bid - kyberData.buyPrice).toFixed(4),
                sell: (kyberData.sellPrice - mexcData.ask).toFixed(4)
            };
    ...
    function applyAlertStyles(element, value) {
      ...
      if (shouldPlaySound && audioEnabled && element.id === 'star10-buy-alert') {
          playSystemAlert();
      }
  }
