const pain = (() => {
  ...
  async function fetchJupPrice() {
      ...
      // Get USDC needed to buy 75 PAIN
      ...
      // Get USDC received for selling 75 PAIN
      ...
      return {
          buyPrice: usdcNeeded / 75,  // USDC per PAIN (buy)
          sellPrice: usdcReceived / 75 // USDC per PAIN (sell)
      };
  }
  ...
  async function updateAlerts() {
      ...
      try {
          ...
          const formatDiff = (val) => isNaN(val) ? 'N/A' : val.toFixed(2);
