const HM = (() => {
    ...
    function handleAudioInitialization() {
        ...
        enableButton.id = 'hm-audio-enable-btn';
        ...
        const section = document.getElementById('hm-buy-alert').closest('.token-section');
...
async function fetchMexcSpotPrice() {
    try {
        ...
        const response = await fetch('https://api.mexc.com/api/v3/depth?symbol=HUSDT&limit=5', {
            method: 'GET',
            headers: {
        ...
        try {
            const proxyResponse = await fetch('https://api.codetabs.com/v1/proxy/?quest=https://api.mexc.com/api/v3/depth?symbol=HUSDT&limit=5');
...
async function updateAlerts() {
    const elements = {
        buy: document.getElementById('hm-buy-alert'),
        sell: document.getElementById('hm-sell-alert')
    };
    ...
    function applyAlertStyles(element, value) {
        ...
        const isBuyAlert = element.parentElement.id === 'hm-buy-alert';
