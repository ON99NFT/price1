...
// Keep the rest of the code the same as previous version
  ...
  async function fetchMexcPrice() {
      try {
          ...
          const response = await fetch(proxyUrl + 'https://contract.mexc.com/api/v1/contract/depth/BROCCOLI_USDT');
  ...
  async function fetchKyberPrice() {
      const addresses = {
          ...
          BROCCOLI: '0x6d5AD1592ed9D6D1dF9b93c793AB759573Ed6714'
      };
  ...
  async function updateAlerts() {
      const elements = {
          buy: document.getElementById('broccoli-buy-alert'),
          sell: document.getElementById('broccoli-sell-alert')
      };
