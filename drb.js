const DRB = (() => {
    ...
    function handleAudioInitialization() {
        ...
        enableButton.id = 'drb-audio-enable-btn';
    ...
    async function fetchMexcPrice() {
        try {
            ...
            const response = await fetch(proxyUrl + 'https://contract.mexc.com/api/v1/contract/depth/DRB_USDT');
    ...
    async function updateAlerts() {
        const elements = {
            ...
            sell: document.getElementById('drb-sell-alert')
        };
